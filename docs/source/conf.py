...
ogp_image = "https://paypal.github.io/Iguanas/_static/iguanas.png"
ogp_description_length = 160
ogp_type = "website"
ogp_site_name = "Iguanas - High-Performance ML Rule Generation Library"
ogp_custom_meta_tags = [
    '<meta name="description" content="High-performance rule generation library. Built on Polars for lightning-fast rule generation." />',
    '<meta name="keywords" content="machine learning, python, polars, rule generation, ruleset optimization" />',
]
